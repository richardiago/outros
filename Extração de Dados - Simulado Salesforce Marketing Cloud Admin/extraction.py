...
URLArray = ['https://www.freecram.net/question/Salesforce.Marketing-Cloud-Administrator.v2022-12-31.q52/northern-trail-outfitters-nto-is-building-a-journey-which-randomly-sends-five-different-versions-of']
...
c = csv.writer(open("./Extração de Dados - Simulado Salesforce Marketing Cloud Admin/MKTCloudAdmin.csv", "a", encoding="utf-8", newline=""))
